...
- proofs: id, room_id FK, user_id FK, proof_date, content, image_url, image_original_name, image_stored_name, image_size, status, confirmed_at, created_at, updated_at
...
## Unique
point_wallets.user_id, rooms.invite_code, room_members(room_id,user_id), proofs(room_id,user_id,proof_date), proof_confirmations(proof_id,confirmer_id), settlements.room_id, settlement_members(settlement_id,user_id) 권장.
